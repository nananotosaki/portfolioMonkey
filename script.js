// Navigation functionality
    ...
    document.getElementById('home_link').addEventListener('click', function(e) {
        ...
        mainContent.innerHTML = `
            <div id="intro" class="m-5">
                ...
                <h2 class="lead"><span class="mark">Aspiring</span> full stack developer</h2>
            </div>
        `;
    });

    document.getElementById('skills_link').addEventListener('click', function(e) {
        e.preventDefault();
        setActiveLink(this);
        mainContent.innerHTML = `
            <div class="m-5">
                <h2 class="display-3 mb-4">Skills</h2>
                <ul class="lead list-inline mb-4">
                ...
                <div id="skill_icons" class="d-flex gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-css" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-javascript" viewBox="0 0 16 16">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-git" viewBox="0 0 16 16">
    ...
    document.getElementById('education_link').addEventListener('click', function(e) {
        e.preventDefault();
        setActiveLink(this);
        mainContent.innerHTML = `
            <div class="m-5">
                <h2 class="display-3 mb-4">Education</h2>
    ...
    document.getElementById('Projects_link').addEventListener('click', function(e) {
        ...
        mainContent.innerHTML = `
            <div class="m-5">
                <h2 class="display-3 mb-4">Projects</h2>
                <ul class="lead list-unstyled">
                    <li class="mb-2">• Coming soon...</li>
                    <li class="mb-2">• More projects on the way...</li>
                </ul>
            </div>
        `;
    });